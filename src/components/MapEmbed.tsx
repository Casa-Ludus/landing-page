...
/**
 * Mapa embebido por defecto apunta a una ubicación genérica en Buenos Aires.
 * Reemplazar `MAP_SRC` en src/config/site.ts con el embed de Google Maps de la tienda.
 */
